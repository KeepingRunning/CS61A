...
def boar_brawl(player_score, opponent_score):
    ...
    score = abs(player_score_ones - opponent_score_tens) * 3
    score = max(score, 1)
    return score
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    for i in range(1, 11, 1):
        test_func = make_averaged(roll_dice, times_called)
        score_of_i = test_func(i, dice)
        if score_of_i > score:
            score = score_of_i
            num = i
    return num
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    score_add = boar_brawl(score, opponent_score)
    if score_add >= threshold:
        return 0
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    scoreadd = sus_update(0, score, opponent_score) - score
    if scoreadd >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
